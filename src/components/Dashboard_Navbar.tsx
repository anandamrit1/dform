  ...
  return (
    <div className="flex flex-row w-full py-7 p-5 sm:px-9 justify-between items-center">
      ...
      <div className="flex space-x-5">
        <div
          className="border-2 px-4 py-1 font-bold rounded-lg border-indigo-500 flex items-center hover:bg-indigo-50 cursor-pointer"
        ...
        <div className="flex justify-center items-center space-x-2 hover:opacity-80 cursor-pointer transition duration-200" onClick={handleImageClick}>
          ...
          <div className="stext-gray-500 text-sm opacity-0 left-0 top-0 sm:pr-8 absolute sm:opacity-100 sm:static">
