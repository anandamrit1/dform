    ...
    return (
        <div className="flex flex-col items-center rounded-lg p-10 my-4 m-auto border-[1px] border-black w-full bg-white">
            ...
            <div id="form-metadata" className="flex flex-col w-full items-center gap-3">
                ...
                />
                <input className='px-4 py-5 w-full rounded-md border-[1px] border-gray-400 focus:border-gray-800 text-gray-400 focus:outline-none' placeholder='Your Answer' onChange={(e) => handleChange("properties", {"placeholder": e.target.value})} value={question?.properties ? question?.properties["placeholderText"] : ""} />
