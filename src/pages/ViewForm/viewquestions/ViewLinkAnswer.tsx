...
const ViewLinkAnswer = ({ question, themeColor }: { question: FormField; themeColor: string }) => {
    ...
    return (
        <div className="flex flex-col w-full my-6 justify-center space-y-2">
            ...
            <Field name={question.id} type="link" placeholder={question.properties?.placeholderText ?? ""} className={`border border-gray-400 focus:border-${themeColor}-500 p-5 rounded-lg outline-none transition duration-200`} />
